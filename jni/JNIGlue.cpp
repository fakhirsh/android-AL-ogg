...
extern "C" 
{
    JNIEXPORT void JNICALL Java_com_fakhir_AndroidALOgg_JNIGlue_Init( JNIEnv* env, jobject thiz, jint width, jint height, jobject assetMgrJava);
    JNIEXPORT void JNICALL Java_com_fakhir_AndroidALOgg_JNIGlue_Step( JNIEnv* env, jobject thiz);
}
